window.CONFIG = {
  ...
  "managers": {
    ...
    "Партнерские продукты и монетизация": [
      "Мальцева Алина",
      "Себелева Яна",
      "Домрачев Дмитрий"
    ]
  ...
  "tools": [
    {
      ...
      "cost": 10,
      "type": "placement",
      "tooltip": "Каталог офферов с приоритетным показом",
      "link": "https://www.tbank.ru/business/"
    },
    {
      "id": "t_community",
      "name": "Рассылка в Т-Комьюнити",
      "cost": 10,
      "type": "mailing",
      "tooltip": "База 120К+ предпринимателей",
      "link": "https://www.tbank.ru/business/"
    },
    {
      "id": "business_secrets",
      ...
      "cost": 20,
      "type": "editorial",
      "tooltip": "Редакционный формат: кейс/интервью",
      "link": "https://www.tbank.ru/business/"
    },
    {
      "id": "bank_mailing",
      "name": "Рассылка в контурах банка",
      "cost": 20,
      "type": "mailing",
      "tooltip": "Охват 45К+ активных клиентов",
      "link": "https://www.tbank.ru/business/"
    },
    {
      "id": "rnd",
      ...
      "cost": 30,
      "type": "integration",
      "tooltip": "Пилотная интеграция в экосистему",
      "link": "https://www.tbank.ru/business/"
    },
    {
      "id": "webinar",
      ...
      "cost": 30,
      "type": "event",
      "tooltip": "Совместный эфир с записью",
      "link": "https://www.tbank.ru/business/"
    },
    {
      "id": "promo_offer",
      "name": "Промо оффера на витрине",
      "cost": 30,
      "type": "promotion",
      "tooltip": "Бейдж «Акция» + топ-3 категория",
      "link": "https://www.tbank.ru/business/"
    },
    {
      "id": "yellow_app",
      "name": "Жёлтое приложение",
      "cost": 40,
      "type": "mobile",
      "tooltip": "Пуш + баннер с диплинком",
      "link": "https://www.tbank.ru/business/"
    },
    {
      "id": "t_journal",
      ...
      "cost": 50,
      "type": "media",
      "tooltip": "Публикация с таргетом по отрасли",
      "link": "https://www.tbank.ru/business/"
    }
  ],
  "tiers": {
    ...
    "20": [
      ...
      {
        "id": "v20_2",
        "title": "Рассылка в контурах банка",
        "tools": [
          "bank_mailing"
        ]
      },
      {
        "id": "v20_3",
        "title": "Витрина + Рассылки в Т-Комьюнити",
        "tools": [
          "showcase",
          "t_community"
        ]
    ...
    "30": [
      ...
      {
        "id": "v30_5",
        "title": "Бизнес Секреты + Т-Комьюнити",
        "tools": [
          "business_secrets",
          "t_community"
        ]
      ...
      {
        "id": "v30_6",
        "title": "Рассылка в контурах банка + Витрина",
        "tools": [
          "bank_mailing",
          "showcase"
        ]
      ...
      {
        "id": "v30_7",
        "title": "Рассылка в контурах банка + Т-Комьюнити",
        "tools": [
          "bank_mailing",
          "t_community"
        ]
    ...
    "40": [
      ...
      {
        "id": "v40_7",
        "title": "Промо оффера + Т-Комьюнити",
        "tools": [
          "promo_offer",
          "t_community"
        ]
      ...
      {
        "id": "v40_8",
        "title": "Бизнес Секреты + Рассылка в контурах банка",
        "tools": [
          "business_secrets",
          "bank_mailing"
        ]
      ...
      {
        "id": "v40_10",
        "title": "Банк-рассылка + Витрина + Т-Комьюнити",
        "tools": [
          "bank_mailing",
          "showcase",
          "t_community"
    ...
    "50": [
      ...
      {
        "id": "v50_2",
        "title": "Жёлтое приложение + Витрина",
        "tools": [
          "yellow_app",
          "showcase"
        ]
      ...
      {
        "id": "v50_3",
        "title": "Жёлтое приложение + Т-Комьюнити",
        "tools": [
          "yellow_app",
          "t_community"
        ]
      ...
      {
        "id": "v50_5",
        "title": "RnD + Рассылка в контурах банка",
        "tools": [
          "rnd",
          "bank_mailing"
        ]
      ...
      {
        "id": "v50_8",
        "title": "Вебинар + Рассылка в контурах банка",
        "tools": [
          "webinar",
          "bank_mailing"
        ]
      ...
      {
        "id": "v50_9",
        "title": "Вебинар + Витрина + Т-Комьюнити",
        "tools": [
          "webinar",
          "showcase",
          "t_community"
      ...
      {
        "id": "v50_10",
        "title": "БС + Банк-рассылка + Витрина",
        "tools": [
          "business_secrets",
          "bank_mailing",
          "showcase"
      ...
      {
        "id": "v50_11",
        "title": "БС + Банк-рассылка + Т-Комьюнити",
        "tools": [
          "business_secrets",
          "bank_mailing",
          "t_community"
  ...
  "tools_metrics": {
    "showcase": {
      "description": "Размещение вашего оффера в каталоге банковских партнёров с приоритетным показом в категории",
      "views": "15 000",
      "leads": "150"
    },
    "t_community": {
      "description": "Таргетированная рассылка по базе предпринимателей (120К+ подписчиков)",
      "views": "45 000",
      "leads": "90"
    },
    "business_secrets": {
      "description": "Интеграция в редакционный материал: кейс, интервью или экспертный комментарий",
      "views": "80 000",
      "leads": "200"
    },
    "bank_mailing": {
      "description": "Включение вашего оффера в регулярную рассылку для клиентов банка",
      "views": "45 000",
      "leads": "135"
    },
    "rnd": {
      "description": "Тестовая интеграция вашего продукта в экосистему банка для пилотной аудитории",
      "views": "5 000",
      "leads": "50"
    },
    "webinar": {
      "description": "Совместный вебинар с банком: презентация решения для целевой аудитории",
      "views": "3 000",
      "leads": "75"
    },
    "promo_offer": {
      "description": "Выделенное размещение с бейджем «Акция» и приоритетным показом в топ-3",
      "views": "20 000",
      "leads": "180"
    },
    "yellow_app": {
      "description": "Пуш-уведомление + баннер в мобильном приложении банка с глубокой ссылкой",
      "views": "100 000",
      "leads": "250"
    },
    "t_journal": {
      "description": "Публикация в Т-Ж с органическим охватом и таргетом по отрасли/региону",
      "views": "150 000",
      "leads": "300"
    }
  },
